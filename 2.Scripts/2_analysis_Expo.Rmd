...
rede_remocao = read.table("1.RawData/rede_remocao7.txt", header = TRUE) #pollen export metric = mean number of pollen removed from the anthers on each interaction
...
rede_performace_m = read.csv2("1.RawData/performace_masculina.csv", header = TRUE, row.names = 1)#efficacy metric= mean total amount of pollen exported x interaction frequency
